                      ...
                      @foreach ($Order as $item)
                         ...
                         <div class="row">
                            <div class="col-12 col-sm-12 col-md-2 text-center">
                                    <img class="img-responsive" src="/storage/public/imagedog/cover_images/{{$item->imagedog}}  " alt="prewiew" width="120" height="80">
                            </div>
                            <div class="col-12 text-sm-center col-sm-12 text-md-left col-md-6">
                                    <a href="/{{$item->id_the_dog}}/{{$item->Post_id}}/view/post"><h4 class="product-name"><strong>Product Name : {{$item->	Breed}},{{$item->title_post}} </strong></h4></a> 
