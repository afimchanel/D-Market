...
<figure class="media">
  ...
  <figcaption class="media-body">
    <a href="/{{$item->id_the_dog}}/{{$item->id_post}}/view/post">
      <h6 class="title text-truncate">{{$item->Detail_Dog}}</h6>
    </a>
    <?php 
    ...
    <dl class="param param-inline small">
      ...
      <dt>
      เวลาที่เริ่มส่ง : {{$item->deliverytime}}
      <span class="badge badge-primary">สถานะสุนัข :</span>
       {{$item->provincename}} ณ เวลา {{$item->updated_at}}
      </dt>
