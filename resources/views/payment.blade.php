  ...
  left: 43px;
    ...
    <div class="">
						...
						<li class="timeline-item">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4 class="timeline-title">ชำระเงิน</h4>
									<p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> รอการยืนยัน</small></p>
								</div>
        ...
        <table class="table col-md-6 container-fluid">
          ...
          <div class="jumbotron jumbotron-fluid col-md-6 container">
              
              <form>
                  <div class="form-row">
                    <div class="col-3">จำนวนเงินที่โอนเงินเข้าบัญชี
                      <input type="text" class="form-control" >
                    </div>
                    <div class="col-4">วันที่โอน
                      <input type="date" class="form-control" >
                    </div>
                    <div class="col">เวลาโอนโดยประมาณ
                      <input type="text" class="form-control" >
                    </div>
                    <div class="col">สนามบินที่ใกล้ที่สุด
                        <input type="text" class="form-control"  placeholder="(เป็นสถานที่รับสุนัข)">
                      </div>
                  ...
                  <button type="button" class="btn btn-success">แจ้งชำระเงิน</button>
                </form>
            </div>
